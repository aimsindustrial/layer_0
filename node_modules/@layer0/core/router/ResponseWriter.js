...
class ResponseWriter extends BaseResponseWriter_1.BaseResponseWriter {
    ...
    constructor(req, res, route, context) {
        ...
        this.redirect = (to, options = {}) => {
            ...
            const redirectLocation = mergeQueryString_1.default(this.request.url, bindParamsToPath_1.default(Route_1.default.pathWithQueryString(toPath, query), this.request.params));
