...
function createDevServer(options) {
    ...
    const jsPort = port + 1;
    const assetPort = port + 2;
    const layer0 = express_1.default();
    const appReady = (options === null || options === void 0 ? void 0 : options.command) || (options === null || options === void 0 ? void 0 : options.run) ? runLocalApp_1.default(jsPort, options) : Promise.resolve();
    ...
    const reloadRouter = () => {
        ...
        router = loadRouter_1.default(routerPath)
            ...
            .setBackend(constants_1.BACKENDS.js, { domainOrIp: constants_1.JS_BACKEND_HOSTNAME, port: jsPort });
    };
    ...
    const layer0Ready = new Promise((resolve, reject) => {
        try {
            const server = layer0.listen(port, resolve);
