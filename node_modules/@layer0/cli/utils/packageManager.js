...
/**
 * Returns the command that the user can run to install @layer0/cli globally using the current package manager.
 * @returns
 */
...
function globalCLIInstallCommand() {
  if (isYarn()) {
    return 'yarn global add @layer0/cli';
  } else {
    return 'npm i -g @layer0/cli';
  }
}
/**
 * Installs @layer0/cli globally using the current package manager.
 */
...
async function installCLIGlobally() {
  ...
  try {
    if (isYarn()) {
      await (0, _run.default)('yarn', ['global', 'add', '@layer0/cli']);
    } else {
      await (0, _run.default)('npm', ['i', '-g', '@layer0/cli']);
    }
...
/**
 * Returns true if @layer0/cli is installed globally, otherwise false.
 */


function isCLIInstalledGlobally() {
  try {
    (0, _resolveGlobal.default)('@layer0/cli');
    return true;
  } catch (e) {
    return false;
  }
