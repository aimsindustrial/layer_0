...
class Context {
  constructor(argv) {
    ...
    if (local) this.apiUrl = 'http://localhost:3000';else if (dev) this.apiUrl = 'https://app.layer0-dev.co';else if (stage) this.apiUrl = 'https://app.layer0-stage.co';else this.apiUrl = apiUrl; // apiUrl argv has default value of production url, so it can be used as fallback
